...
function PhotoLayers() {
  return <><div className="photo-layer photo-layer--day" style={{ backgroundImage: `url('${import.meta.env.BASE_URL}assets/hero-yard-day-real.jpg')` }}/><div className="photo-layer photo-layer--night" style={{ backgroundImage: `url('${import.meta.env.BASE_URL}assets/hero-yard-night-real.jpg')` }}/></>;
}
...
export function OfferPage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Oferta" title="Plac, hala i przygotowanie do zimy." text="Wybierz zakres odpowiedni dla swojej jednostki. Szczegóły i termin ustalimy telefonicznie." image="/assets/gallery/transport-do-hali.jpg" imageAlt="Łódź przenoszona na przygotowany wózek"/><section className="section"><div className="container offer-page-grid">{offers.map(({icon: Icon,...item}) => <article className="offer-detail" key={item.title}><div className="offer-detail__icon"><Icon/></div><h2>{item.title}</h2><p>{item.text}</p><ul>{item.points.map(point => <li key={point}><Check/>{point}</li>)}</ul></article>)}</div></section><PrimaryCta/></>;
}

export function PricingPage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Cennik" title="Jasne stawki za pełny sezon." image="/assets/gallery/lodz-motorowa.jpg" imageAlt="Łódź motorowa ustawiona na placu"/><section className="section pricing-page"><div className="container pricing-groups"><article className="pricing-group pricing-group--yard"><header><span><ShieldCheck/>Monitorowany plac</span><h2>Postój na placu</h2><p>Opłata obejmuje pełny sezon od 1 października do 30 kwietnia.</p></header><PriceCards/></article><article className="pricing-group pricing-group--hall"><div className="pricing-group__photo"><img src={`${import.meta.env.BASE_URL}assets/gallery/lodzie-zimowanie-hala.jpg`} alt="Łodzie przechowywane w ogrzewanej hali"/></div><div className="pricing-group__body"><span><Building2/>Ogrzewana hala</span><h2>Wycena indywidualna</h2><p>Podaj długość i szerokość łodzi. Sprawdzimy dostępność miejsca i ustalimy cenę.</p><a className="button button--primary" href={phone.href}><Phone/>Zadzwoń</a><div className="service-note"><Wrench/><p>Serwis zimowy wyceniamy oddzielnie po ustaleniu zakresu prac.</p></div></div></article></div></section><PrimaryCta/></>;
}

export function SitePage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Plac" title="1800 m² dla małych i dużych jednostek." text="Plac jest ogrodzony, oświetlony i monitorowany. Wjazd znajduje się od ul. Sybiraków." image="/assets/hero-yard-day-real.jpg" imageAlt="Utwardzony plac widziany z lotu ptaka"/><section className="section site-page"><div className="container site-facts"><article className="site-facts__main"><Ruler/><span className="overline">Plac w Giżycku</span><strong>1800 <span className="metric-unit">m<sup>2</sup></span></strong><p>Utwardzona przestrzeń przeznaczona do zimowania łodzi.</p></article><article><ShieldCheck/><h2>Monitorowany</h2><p>Nadzór nad terenem podczas sezonu zimowego.</p></article><article><Fence/><h2>Ogrodzony</h2><p>Wydzielony plac przy ul. Sybiraków.</p></article><article><Lamp/><h2>Oświetlony</h2><p>Czytelna przestrzeń również po zmroku.</p></article></div><div className="container arrival"><div><span className="overline">Przed przyjazdem</span><h2>Wystarczą trzy ustalenia.</h2></div><ol><li><Check/><strong>Podaj długość łodzi</strong></li><li><Check/><strong>Wybierz plac lub halę</strong></li><li><Check/><strong>Ustal termin przyjazdu</strong></li></ol></div></section><PrimaryCta/></>;
}

export function HallPage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Ogrzewana hala" title="Postój pod dachem przez całą zimę." text="Miejsce dobieramy do wymiarów jednostki. Dostępność oraz cenę potwierdzamy przed przyjęciem łodzi." image="/assets/gallery/hala-wnetrze.jpg" imageAlt="Przestronne wnętrze ogrzewanej hali"/><section className="section hall-page"><div className="container hall-benefits"><article><Warehouse/><h2>Ogrzewane wnętrze</h2><p>Osłonięte miejsce dla jednostek wymagających postoju pod dachem.</p></article><article><Ruler/><h2>Miejsce dopasowane do łodzi</h2><p>Przed rezerwacją ustalamy długość i szerokość jednostki.</p></article><article><Phone/><h2>Wycena indywidualna</h2><p>Zadzwoń — sprawdzimy dostępność i podamy cenę.</p></article></div><div className="container hall-photo-pair hall-photo-pair--trio"><img src={`${import.meta.env.BASE_URL}assets/gallery/lodz-w-hali.jpg`} alt="Łódź przechowywana wewnątrz ogrzewanej hali"/><img src={`${import.meta.env.BASE_URL}assets/gallery/lodzie-zimowanie-hala.jpg`} alt="Łodzie ustawione w ogrzewanej hali"/><img src={`${import.meta.env.BASE_URL}assets/gallery/podpory-lodzi.jpg`} alt="Łódź zabezpieczona na regulowanych podporach w hali"/></div></section><PrimaryCta title="Zapytaj o miejsce w ogrzewanej hali."/></>;
}

export function GalleryPage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Galeria" title="Galeria" text="Plac, ogrzewana hala, przygotowane wózki i łodzie przechowywane w Giżycku." image="/assets/gallery/wodowanie-dzwigiem.jpg" imageAlt="Łódź bezpiecznie podnoszona za pomocą dźwigu"/><section className="section gallery-page"><div className="container gallery-page__head"><strong>{galleryPhotos.length} zdjęć</strong><span>Giżycko · ul. Sybiraków</span></div><div className="container"><PhotoGallery photos={galleryPhotos}/></div></section><PrimaryCta/></>;
}

export function ContactPage(_props: Readonly<EmptyPageProps>) {
  return <><PageHero label="Kontakt" title="Ustalmy miejsce dla Twojej łodzi." text="Zadzwoń i podaj długość jednostki oraz wybraną formę postoju." image="/assets/gallery/hala-zewnatrz.jpg" imageAlt="Ogrzewana hala oraz przygotowane wózki w Giżycku"/><section className="section contact-page"><div className="container contact-layout"><a className="contact-main" href={phone.href}><small>Telefon</small><strong>{phone.display}</strong><span>Zadzwoń teraz <ArrowRight/></span></a><div className="contact-info"><article><MapPin/><small>Lokalizacja</small><strong>{address}</strong><p>Wjazd od ul. Sybiraków.</p></article><article><Clock3/><small>Sezon</small><strong>{season}</strong><p>Postój od października do końca kwietnia.</p></article><article><Wrench/><small>Serwis</small><strong>Do ustalenia</strong><p>Przygotowanie możesz zlecić nam albo wykonać samodzielnie.</p></article></div></div></section></>;
}
